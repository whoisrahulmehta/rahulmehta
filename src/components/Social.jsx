      ...
      <div className="boxes flex sm:flex-col flex-row justify-start items-center sm:w-[100%] w-[100%] sm:h-[80%] h-[100vh]">
          ...
          {[
            ...
            >
              <a
                href={ic.link}
                target="_blank"
                className={`w-[100%] h-[100%] sm:scale-1 scale-[0.7] `}
              >
                {ic.icon}
        ...
        <div className="box sm:flex sm:flex-row justify-center items-center w-[100%] sm:h-[40%] h-[100%] ">
          {[
            ...
            {
              name: "LinkedIn",
              link: "https://www.linkedin.com/in/rahul-mehta-83a29131b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ",
              icon: <BsLinkedin size="7rem" />,
              color: "text-blue-500",
            },
            {
              name: "Whatsapp",
